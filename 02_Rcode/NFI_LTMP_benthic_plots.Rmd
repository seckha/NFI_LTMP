...
SB_coral_transect$Category <- ordered(SB_coral_transect$Category, levels = c("Acropora_branch","Acropora_non_branch","Montipora_encrusting","Montipora_plating","Pocilloporidae","Acanthastrea","Goniopora","Platygyra","Porites", "Other hard coral"))
